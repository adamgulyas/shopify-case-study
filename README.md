# Shopify: A~~n E-commerce~~ Payments Company
...
| 2019 | $642.24 million (40.65%) | $933.93 million (59.35%) |
...
<!-- New product crowdfunding could be a net positive add for Shopify as it would encourage merchant growth and audience interaction, giving the audience something to participate in as well. The idea is that it leads to bigger merchants, which leads to higher sales, which leads to more payments commissions for Shopify. -->

<!-- >What technologies would this additional product or service utilize? -->
<!-- As far as technologies required to build a feature like this, Shopify's current technology and product stacks possess the needed tools. It would require the e-commerce store to display the product to be made, and then payment processing for customers to fund the building of the product. The most effort would be in creating the system that utilizes these components and provides a simple user experience on both the merchant's and the customer's end. -->
